...
if(cljs.core.truth_((function (){var and__18109__auto__ = selected_QMARK_;
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__29335){
var map__29337 = p__29335;
var map__29337__$1 = ((cljs.core.seq_QMARK_.call(null,map__29337))?cljs.core.apply.call(null,cljs.core.hash_map,map__29337):map__29337);
var args = map__29337__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__29337__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__29337__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__29337__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__29337__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__29337__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__29337__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__29337__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__29337__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__29337__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var multi_select_QMARK_ = cljs.core.get.call(null,map__29337__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__29337,map__29337__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__29332_SHARP_){
return item_renderer.call(null,p1__29332_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29337,map__29337__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__29337,map__29337__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__29333_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__29333_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29337,map__29337__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
:((function (selected,map__29337,map__29337__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__29334_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__29334_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29337,map__29337__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
)),choices);
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__29339){
...
return ((function (map__29340,map__29340__$1,args){
return (function() { 
var G__29343__delegate = function (p__29341){
...
while (G__29344__i < G__29344__a.length) {G__29344__a[G__29344__i] = arguments[G__29344__i + 0]; ++G__29344__i;}
  p__29341 = new cljs.core.IndexedSeq(G__29344__a,0);
} 
return G__29343__delegate.call(this,p__29341);};
G__29343.cljs$lang$maxFixedArity = 0;
G__29343.cljs$lang$applyTo = (function (arglist__29345){
var p__29341 = cljs.core.seq(arglist__29345);
return G__29343__delegate(p__29341);
});
G__29343.cljs$core$IFn$_invoke$arity$variadic = G__29343__delegate;
return G__29343;
})()
;
;})(map__29340,map__29340__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq29338){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29338));
});

//# sourceMappingURL=selection_list.js.map?rel=1439021442850