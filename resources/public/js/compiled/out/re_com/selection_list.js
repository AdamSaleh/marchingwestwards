...
if(cljs.core.truth_((function (){var and__17902__auto__ = selected_QMARK_;
...
if(cljs.core.truth_((function (){var and__17902__auto__ = required_QMARK_;
if(cljs.core.truth_(and__17902__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__31246){
...
var args = map__31248__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__31248__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__31248__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__31248__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__31248__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__31248__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__31248__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__31248__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__31248__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__31248__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var multi_select_QMARK_ = cljs.core.get.call(null,map__31248__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__31248,map__31248__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__31243_SHARP_){
return item_renderer.call(null,p1__31243_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__31248,map__31248__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__31248,map__31248__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__31244_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__31244_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__31248,map__31248__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
:((function (selected,map__31248,map__31248__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_){
return (function (p1__31245_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__31245_SHARP_,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__31248,map__31248__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,multi_select_QMARK_))
)),choices);
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__18954__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__31250){
...
var args = map__31251__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"validate-args-macro","validate-args-macro",-1576181756,null),new cljs.core.Symbol(null,"selection-list-args-desc","selection-list-args-desc",-219283300,null),new cljs.core.Symbol(null,"args","args",-1338879193,null),"selection-list")))].join('')));
}

return ((function (map__31251,map__31251__$1,args){
return (function() { 
var G__31254__delegate = function (p__31252){
var map__31253 = p__31252;
var map__31253__$1 = ((cljs.core.seq_QMARK_.call(null,map__31253))?cljs.core.apply.call(null,cljs.core.hash_map,map__31253):map__31253);
var args__$1 = map__31253__$1;
...
while (G__31255__i < G__31255__a.length) {G__31255__a[G__31255__i] = arguments[G__31255__i + 0]; ++G__31255__i;}
  p__31252 = new cljs.core.IndexedSeq(G__31255__a,0);
} 
return G__31254__delegate.call(this,p__31252);};
G__31254.cljs$lang$maxFixedArity = 0;
G__31254.cljs$lang$applyTo = (function (arglist__31256){
var p__31252 = cljs.core.seq(arglist__31256);
return G__31254__delegate(p__31252);
});
G__31254.cljs$core$IFn$_invoke$arity$variadic = G__31254__delegate;
return G__31254;
})()
;
;})(map__31251,map__31251__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq31249){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31249));
});

//# sourceMappingURL=selection_list.js.map?rel=1443334744315