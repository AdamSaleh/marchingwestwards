...
return cljs.core.reduce.call(null,(function (result,p__28102){
...
var vec__28105 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__28105,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__28105,(1),null);
var ab = cljs.core.nth.call(null,vec__28105,(2),null);
 ...
 */
clojure.data.EqualityPartition = (function (){var obj28110 = {};
return obj28110;
})();
...
if((function (){var and__17902__auto__ = x;
...
var x__18550__auto__ = (((x == null))?null:x);
return (function (){var or__17914__auto__ = (clojure.data.equality_partition[goog.typeOf(x__18550__auto__)]);
if(or__17914__auto__){
return or__17914__auto__;
} else {
var or__17914__auto____$1 = (clojure.data.equality_partition["_"]);
 ...
 * Implementation detail. Subject to change.
 */
clojure.data.Diff = (function (){var obj28112 = {};
return obj28112;
})();
...
return (function (){var or__17914__auto__ = (clojure.data.diff_similar[goog.typeOf(x__18550__auto__)]);
if(or__17914__auto__){
return or__17914__auto__;
} else {
var or__17914__auto____$1 = (clojure.data.diff_similar["_"]);
if(or__17914__auto____$1){
return or__17914__auto____$1;
} else {
...
if((function (){var G__28113 = x;
if(G__28113){
var bit__18588__auto__ = (G__28113.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__18588__auto__) || (G__28113.cljs$core$IMap$)){
return true;
} else {
if((!G__28113.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__28113);
} else {
return false;
}
}
...
if((function (){var G__28114 = x;
if(G__28114){
var bit__18588__auto__ = (G__28114.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__18588__auto__) || (G__28114.cljs$core$ISet$)){
return true;
} else {
if((!G__28114.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__28114);
} else {
return false;
}
}
...
if((function (){var G__28115 = x;
if(G__28115){
var bit__18588__auto__ = (G__28115.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__18588__auto__) || (G__28115.cljs$core$ISequential$)){
return true;
} else {
if((!G__28115.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__28115);
} else {
return false;
}
}
...
return (function (){var G__28116 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__28116) {
case "map":
...
//# sourceMappingURL=data.js.map?rel=1443334738890