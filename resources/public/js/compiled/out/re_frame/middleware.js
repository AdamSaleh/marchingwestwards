...
if(!((function (){var G__28087 = app_db;
if(G__28087){
...
return G__28087.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__28087.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__28087);
} else {
return false;
}
}
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__28093){
...
return cljs.core.get_in.call(null,new_db,p1__28094_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__28095_SHARP_){
return cljs.core.get_in.call(null,db,p1__28095_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__28096__i = 0, G__28096__a = new Array(arguments.length -  2);
while (G__28096__i < G__28096__a.length) {G__28096__a[G__28096__i] = arguments[G__28096__i + 2]; ++G__28096__i;}
  in_paths = new cljs.core.IndexedSeq(G__28096__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__28097){
var f = cljs.core.first(arglist__28097);
arglist__28097 = cljs.core.next(arglist__28097);
var out_path = cljs.core.first(arglist__28097);
var in_paths = cljs.core.rest(arglist__28097);
...
//# sourceMappingURL=middleware.js.map?rel=1443334738765