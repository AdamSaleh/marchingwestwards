...
if(!((function (){var G__26300 = app_db;
if(G__26300){
...
return G__26300.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__26300.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__26300);
} else {
return false;
}
}
...
while (G__26305__i < G__26305__a.length) {G__26305__a[G__26305__i] = arguments[G__26305__i + 0]; ++G__26305__i;}
  args = new cljs.core.IndexedSeq(G__26305__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__26306){
var args = cljs.core.seq(arglist__26306);
...
return cljs.core.get_in.call(null,new_db,p1__26307_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__26308_SHARP_){
return cljs.core.get_in.call(null,db,p1__26308_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__26309__i = 0, G__26309__a = new Array(arguments.length -  2);
while (G__26309__i < G__26309__a.length) {G__26309__a[G__26309__i] = arguments[G__26309__i + 2]; ++G__26309__i;}
  in_paths = new cljs.core.IndexedSeq(G__26309__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__26310){
var f = cljs.core.first(arglist__26310);
arglist__26310 = cljs.core.next(arglist__26310);
var out_path = cljs.core.first(arglist__26310);
var in_paths = cljs.core.rest(arglist__26310);
...
//# sourceMappingURL=middleware.js.map?rel=1439021438026